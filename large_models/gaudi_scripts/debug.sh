...
bash gaudi_scripts/run.sh MeZO-SGD Copa\
	--learning_rate 1e-06 --max_steps 10000 --save_perturbation --sparse_perturbation --sparse_perturbation_type scale --gradient_sparsity 0.75
#	--learning_rate 1e-06 --max_steps 10000 --sparse_perturbation --sparse_perturbation_type random --gradient_sparsity 0.75 --save_perturbations
